app.controller('CreateWordTranslationController', function ($scope, $window, $timeout, $modal, $modalInstance, WordsService, WordTranslationService, ModalService, UserService, ConstService, languageId) {
